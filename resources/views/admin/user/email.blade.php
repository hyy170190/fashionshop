    ...
    <div class="container-scroller">
        ...
        <div class="container d-flex justify-content-center">
            <div class="col-md-8 grid-margin stretch-card" style="margin-top: 110px">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Send email to <span class="text-primary text-lowercase">{{ $order[0]->user->email }}</span></h4>
                        <form class="forms-sample mt-5" action="{{ route('userEmail#send',$order[0]->id) }}" method="POST">
                            @csrf
                            ...
                            <a href="{{ route('order#list') }}" class="btn btn-dark">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
